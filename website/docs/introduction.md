...
Prodcat is a powerful tool for generating and managing software product documentation websites. It allows you to take a simple list of software products and generate a beautiful, feature-rich Docusaurus website. Prodcat is perfect for businesses and individuals who want to create professional-looking software product catalogs and documentation with minimal effort.
...
1.  **Installation:** Install Prodcat using npm: `npm install -g prodcat`.
2.  **Initialization:** Create a new project: `prodcat init my-software-product-site`.
3.  **Add Software Products:** Add your software products to the `products.js` file.
4.  **Generate Site:** Run `prodcat generate` to build your website.
5.  **View Site:** Your new software product website is ready in the `website` directory.
